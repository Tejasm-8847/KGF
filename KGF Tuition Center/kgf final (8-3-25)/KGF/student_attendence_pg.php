...
// Fetch student's name, ClassesAttended, and TotalClasses from the Student table using StudentID from session
$studentID = $_SESSION['student_id'];
$query = "SELECT Name, ClassesAttended, TotalClasses FROM Student WHERE StudentID = ?";
$stmt = $conn->prepare($query);
$stmt->bind_param("i", $studentID);
$stmt->execute();
$stmt->bind_result($studentName, $classesAttended, $totalClasses);
$stmt->fetch();
$stmt->close();
...
<head>
  ...
  <title>Modified Page with Sidebar - Mentor</title>
...
<body>
  ...
  <div id="sidebar">
    ...
    <ul>
        <a href="student_attendence_pg.php"><li><i class="bi bi-check-circle"></i> Attendance</li></a>
